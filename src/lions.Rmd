...
| behav_r1 | Rater 1's coding of the animal's behaviour at each time point. | In the example file, you'll find: "pacing", "sleeping", "standing", "lying", "running". Your codes may be different. |
| behav_r2 | Rater 2's coding of the animal's behaviour at each time point. | as above. |
| loc_r1    | Rater 1's coding of the animal's location at each time point. |  In the example file, you'll find: "zone_1", "zone_2", "zone_3", "zone_4". Your codes may be different. |
| loc_r2    | Rater 2's coding of the animal's location at each time point. |  as above. |
...
behav <- animals %>% select(behav_r1, behav_r2)
```
...
Does the tiger behave differently when it’s close to feeding time? To look at
...
```{r cont}
cont <- table(animals$period, animals$behav_r2)
cont
```
